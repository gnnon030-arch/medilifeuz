      ...
      <section className="grid md:grid-cols-2 gap-10 items-center py-10 md:py-16">
        <div className="space-y-6 md:pl-12 lg:pl-24">
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-extrabold tracking-tight leading-[1.05]">
            <span className="absolute inset-0 gradient-primary rounded-full blur-3xl scale-110 opacity-0 text-6xl">MediLife</span>
        ...
        <div className="flex justify-center">
          <div className="relative">
            ...
            <img src={logo} alt="MediLife" className="text-primary md:text-8xl lg:text-9xl text-7xl" />
          </div>
        </div>
      </section>
