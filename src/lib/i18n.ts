...
const resources = {
  ...
  en: {
    translation: {
      ...
      cart: { add: "Added to cart", remove: "Removed from cart", empty: "Cart is empty", checkout: "Checkout", pickup: "Pickup", courier: "Courier", free_courier: "Courier 10:00–22:00 free", outside_hours: "Off-hours — +20 000 sum", total: "Total", subtotal: "Subtotal", delivery_fee: "Delivery", submit: "Place order", submitted: "Order placed!", current_time: "Current time (Uzbekistan Namangan)" },
