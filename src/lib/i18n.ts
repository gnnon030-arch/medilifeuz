...
const resources = {
  ...
  ru: {
    translation: {
      ...
      cart: { add: "Добавлено в корзину", remove: "Убрано из корзины", empty: "Корзина пуста", checkout: "Оформление", delivery_only: "Только через службу доставки", delivery_free_city: "Доставка по всему городу бесплатно", total: "Итого", subtotal: "Товары", delivery_fee: "Доставка", submit: "Заказать", submitted: "Заказ отправлен!", current_time: "Текущее время (Узбекистан Наманган)", address_text: "Адрес (текст)", address_text_ph: "Улица, дом, квартира... (минимум 20 символов)", address_map: "Выбрать в Yandex Картах", address_map_google: "Выбрать в Google Maps", address_map_btn: "Выбрать через Yandex Карты", address_map_btn_google: "Выбрать через Google Maps", address_picked: "Выбранный адрес", address_method: "Способ ввода адреса", address_method_text: "Текст", address_method_google: "Google Maps", address_method_yandex: "Yandex Maps", address_min: "Адрес должен содержать не менее 20 символов (пробелы не считаются)", note_ph: "Заметка (необязательно)", order_list: "Список заказа", my_location: "Моё местоположение", map_hint: "Кликните по карте или перетащите маркер", delete_order: "Удалить заказ" },
